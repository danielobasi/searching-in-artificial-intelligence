...
#In this example, we define a function called dfs that takes two arguments: graph, which is a dictionary representing the graph we want to search, and start, which is the starting node for the search.
